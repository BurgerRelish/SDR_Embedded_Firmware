...
void test_compression() {
    ...
    ps_string message = "{ \"timestamp\": 1685632656, \"RD\": [ {\"mid\": \"1234598127\",\"avgV\": 228.08,\"maxV\": 234.5,\"minV\": 226.49,\"stdV\": 1.2312,\"avgF\": 49.431,\"maxF\": 50.670,\"minF\": 48.897,\"stdF\": 0.2131,\"avgSP\": 704.00,\"maxSP\": 765.23,\"minSP\": 671.58,\"stdSP\": 43.764,\"avgPF\": 385.75,\"maxPF\": 586.00,\"minPF\": 125.50,\"stdPF\": 34.239,\"KWH\": 0.9082,\"state\": true,\"sw_time\": 1685732656}]}";

    ps_string result = compressor.compressString(message);
...
void test_decompression() {
    ...
    ps_string message = "";

    ps_string result = decompressor.decompressString(message);
    TEST_ASSERT_NOT_EQUAL(0, result.length());
